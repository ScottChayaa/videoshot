...
| **4** | 取圖精靈第一、二步（含播放器、收斂） | L | [階段 4a](2026-09-13-階段4a-精靈外殼與第一步.md)／4b 待產出 |
...
**拆成兩份細節計畫**（10 個任務、第一個有 UI 的階段，單一計畫過大）：
[階段 4a](2026-09-13-階段4a-精靈外殼與第一步.md) 涵蓋 T4.1～T4.4、T4.9；階段 4b（待產出）涵蓋 T4.5～T4.8、T4.10。
