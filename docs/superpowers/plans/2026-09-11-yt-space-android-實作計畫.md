...
| 階段 | 內容 | 規模 | 細節計畫 |
|---|---|---|---|
| **0** | **截圖 POC** ＋ 開發環境 ＋ 其他待實測項目 ⚠️ 出口閘門 | M | [階段 0](2026-09-11-階段0-截圖POC.md) |
| **1** | Gradle 骨架（`:app` ＋ `:core`）＋ storyboard 移植 | M | [階段 1](2026-09-11-階段1-骨架與storyboard.md) |
...
| # | 任務 | 規模 | 驗收 |
|---|---|---|---|
| T7.1 | 底部導覽五格（取圖只用顏色區分）、淺色／深色主題、間距與字級尺標、平板 ≥ 600dp 加欄 | M | 手冊 §零 |
